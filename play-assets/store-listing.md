# FitToGym — Google Play store listing copy

Paste these into the Play Console listing. Character counts are noted so you
stay within Google's limits (App name <= 30, Short description <= 80, Full
description <= 4000).
...
```
Play structured .fit running workouts with beeps, BLE heart rate & mini view.
```
...
FitToGym does not include the Internet permission. That means it is technically incapable of sending your data anywhere. Everything — your imported workouts, your settings, and your heart-rate readings — stays on your device and is removed when you uninstall.
...
1. Export or download a structured workout as a .fit file.
2. Share it to FitToGym, or open it with FitToGym from your files app.
3. Set your threshold pace and preferred units (km or miles) so targets and Training Stress are calculated for you.
4. (Optional) Pair your Bluetooth heart-rate monitor.
5. Press start and follow the beeps.
...
• Notifications — show the workout-in-progress notification.
...
- Full description above is ~2,500 characters — well under the 4,000 limit, leaving
  room to add device-specific notes later.
- Keep claims accurate: do not add features (GPS tracking, cloud sync, social) the
  app does not have, or Google may reject the listing.
- If you later add crash reporting (Firebase), you must add the INTERNET permission
  and update both this copy and the privacy policy / Data safety form.
